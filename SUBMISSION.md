...
<img alt="Forked Repository" src="./docs/screenshots/1.1.png">
...
<img alt="App Service Running" src="./docs/screenshots/1.2.png">
...
<img alt="GitHub Actions Workflow" src="./docs/screenshots/1.3.png">
...
<img alt="Live Web UI" src="./docs/screenshots/1.4.1.png">
<img alt="Live Web UI App Settings" src="./docs/screenshots/1.4.2.png">
...
<img alt="ACR Repositories" src="./docs/screenshots/2.1.png">
...
<img alt="ACR Image Tags" src="./docs/screenshots/2.3.2.png">
...
<img alt="Function App State" src="./docs/screenshots/4.1.2.png">
...
<img alt="AKS Cluster Overview" src="./docs/screenshots/5.1.png">
...
<img alt="VALIDATE_URL App Setting" src="./docs/screenshots/5.5.png">
<img alt="AKS Validator Running" src="./docs/screenshots/5.6.png">
...
<img alt="Blob Container with PDFs" src="./docs/screenshots/6.1.png">
<img alt="ACI Report Job Evidence" src="./docs/screenshots/6.5.png">
<img alt="ACI Report Job Details" src="./docs/screenshots/6.6.png">
...
<img alt="Web App Wiring App Settings" src="./docs/screenshots/7.1.png">
...
<img alt="Happy Path - Orchestration Start" src="./docs/screenshots/7.2.1.png">
<img alt="Happy Path - Validation Step" src="./docs/screenshots/7.2.2.png">
<img alt="Happy Path - ACI Report Job" src="./docs/screenshots/7.2.3.png">
<img alt="Happy Path - Orchestration Completed" src="./docs/screenshots/7.2.4.png">
...
<img alt="Reject Path - Invalid Order Submitted" src="./docs/screenshots/7.3.1.png">
<img alt="Reject Path - Rejected Status" src="./docs/screenshots/7.3.2.png">
